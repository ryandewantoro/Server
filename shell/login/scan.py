...
def Logo():
	run()
	subprocess.call("toilet -f standard -F gay TUAN-DESTROY",shell=True)
...
while(angka<1):
    run()
    mengetik(D+'\n  SCAN ADMIN LOGIN')
    mengetik(C+"  By: TUAN-DESTROY")
    mengetik(G+"  Team: D45H-EXPLOITER-7EAM")
    mengetik(I+"  Thanks To: AllMember D45H-EXPLOITER-7EAM")
