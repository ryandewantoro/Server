...
docker run --name=pihole -e TZ=Asia/Jakarta -e WEBPASSWORD=dJknse -e SERVERIP=192.168.62.216 -v pihole:/etc/pihole -v dnsmasq:/etc/dnsmasq.d -p 1000:80 -p 53:53/tcp -p 53:53/udp --restart=always pihole/pihole
