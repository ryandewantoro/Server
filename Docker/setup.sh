...
docker run --name=pihole -e TZ=Asia/Jakarta -e WEBPASSWORD=YOURPASS -e SERVERIP=YOUR.SERVER.IP -v pihole:/etc/pihole -v dnsmasq:/etc/dnsmasq.d -p 80:80 -p 53:53/tcp -p 53:53/udp --restart=unless-stopped pihole/pihole
